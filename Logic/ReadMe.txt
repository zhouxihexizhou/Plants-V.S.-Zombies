...
LogicDoc.h，LogicDoc.cpp - 文档
这些文件包含 CLogicDoc 类。编辑这些文件可以添加特殊文档数据并可实现文件保存和加载(通过 CLogicDoc::Serialize)。

LogicView.h，LogicView.cpp - 文档的视图
这些文件包含 CLogicView 类。
CLogicView 对象用于查看 CLogicDoc 对象。
